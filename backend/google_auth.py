...
#fetch FNCLIENT ID/SECRETS from environments variables 
...
def login():
    ...
    #print(dir(session))
    #store clients authentication state
    result = session.create_authorization_url(AUTHORIZATION_URL)
    print(result)
    #uri,state = session.create_authorization_url(AUTH_REDIRECT_URI)
    #print(uri)
    #print(state)
